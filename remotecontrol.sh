...
function vps()
{
	...
	sshpass -p tc ssh tc@192.168.174.134 "nmap $ipadd > nmap.txt;whois $ipadd > whois.txt"
	#viewing the results
	sshpass -p tc ssh tc@192.168.174.134 "cat nmap.txt"
	echo "Press enter to view the whois result"
	read
	sshpass -p tc ssh tc@192.168.174.134 "cat whois.txt"
